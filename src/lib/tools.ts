...
export const tools: Tool[] = [
  ...
  { name: 'PDF to PowerPoint', description: 'Convert your PDF to a presentation.', icon: LucidePresentation, category: 'Convert PDF', categoryIcon: ArrowRightLeft, processorType: 'generic' },
  ...
  { name: 'PPT to PDF', description: 'Convert PowerPoint presentations to PDF.', icon: LucidePresentation, category: 'Convert PDF', categoryIcon: ArrowRightLeft, processorType: 'generic' },
