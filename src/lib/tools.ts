...
export const tools: Tool[] = [
  ...
  { name: 'PDF to PowerPoint', description: 'Convert your PDF to a presentation.', icon: FilePresentation, category: 'Convert PDF', categoryIcon: ArrowRightLeft, processorType: 'generic' },
  ...
  { name: 'PPT to PDF', description: 'Convert PowerPoint presentations to PDF.', icon: FilePresentation, category: 'Convert PDF', categoryIcon: ArrowRightLeft, processorType: 'generic' },
