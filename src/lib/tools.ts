...
export const tools: Tool[] = [
  ...
  // Advanced Features
  { name: 'Batch Process PDFs', description: 'Process multiple PDFs at once.', icon: FileBox, category: 'Advanced Features', categoryIcon: Rocket, processorType: 'generic' },
  { name: 'API Integration', description: 'Integrate with external APIs.', icon: LinkIcon, category: 'Advanced Features', categoryIcon: Rocket, processorType: 'generic' },
