      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
               <div className={cn("bg-gradient-to-b from-white to-gray-50 dark:from-gray-50 dark:to-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 h-52 sm:h-48 md:h-52 rounded-xl border border-gray-200 dark:border-gray-300")}>
                  <div className="flex flex-col h-full relative overflow-hidden rounded-xl">
                    {tool.isNew && (
                        <motion.div
                          className="absolute top-3 right-3 px-3 py-1 bg-orange-500 text-white text-xs font-bold rounded-full shadow-md z-10"
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
